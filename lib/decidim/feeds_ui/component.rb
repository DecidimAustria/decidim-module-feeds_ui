...
Decidim.register_component(:feeds_ui) do |component|
  ...
  #   resource.model_class_name = "Decidim::FeedsUi::SomeResource"
  #   resource.template = "decidim/feeds_ui/some_resources/linked_some_resources"
  # end
